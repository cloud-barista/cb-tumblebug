...
* Enhance error handling in MCI Policy check by @bconfiden2 in https://github.com/cloud-barista/cb-tumblebug/pull/1170
...
* Add get VM list in a VMGroup within a MCI by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1176
* Add API to get VMGroup list in a MCI by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1177
...
* Add scaleOut feature for VMGroup in a MCI by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1181
...
* Remove associated NLBs with MCI del by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1201
...
* HotFix for delete mci err due to nlb by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1203
...
* Add get mci access info feature by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1218
* Apply omitempty for nlb obj in mciAccessInfo by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1221
...
* feat: add VM to MCI dynamically by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1237
...
* fix:CoreDelAllMci to  DelAllMci by @arshad-k7 in https://github.com/cloud-barista/cb-tumblebug/pull/1236
* Add StrictHostKeyChecking=no for mci file copy by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1240
...
* Add test-mci-dynamic-all-for-one.sh by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1243
* Update `availableDataDisk` REST API by @jihoon-seo in https://github.com/cloud-barista/cb-tumblebug/pull/1244
* Change func name `CorePostMciVm` into `CreateMciVm` by @Rohit-R2000 in https://github.com/cloud-barista/cb-tumblebug/pull/1219
...
* Enhance error handling for DataDiskIds in mci provision by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1251
...
* Add CreateSystemMciDynamic for network probe by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1254
...
* Fix response message for MCI terminate by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1014
...
* Add script for remote copy file to MCI VMs by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1031
...
* Add Cloud Adaptive Network configuration when creating MCI by @yunkon-kim in https://github.com/cloud-barista/cb-tumblebug/pull/1054
* Add Docker engine installation script by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1060
* Remove duplicated script create-single-vm-mci.sh by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1058
...
* Enhance output for mci status by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1116
...
* Provide naming rule checking for dynamic MCI provisioning by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1128
...
* Reconstuct resource IDs for a registered MCI by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1139
* Enhance stability and speed of TB by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1140
* Add script for test-mci-dynamic-all by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1142
* Fix misspell by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1143
* Fix control mci force option error by @seokho-son in https://github.com/cloud-barista/cb-tumblebug/pull/1146
...
- Add list MCI simple option [#731](https://github.com/cloud-barista/cb-tumblebug/pull/731)
- Add MCI status count feature and update MCI response field [#732](https://github.com/cloud-barista/cb-tumblebug/pull/732)
...
- Enhance capability of mci recommendation [#833](https://github.com/cloud-barista/cb-tumblebug/pull/833)
...
- Remove control action parameters from get mci [#928](https://github.com/cloud-barista/cb-tumblebug/pull/928)
- Add feature for connection with geolocation [#936](https://github.com/cloud-barista/cb-tumblebug/pull/936)
- Enable dynamic MCI provisioning [#879](https://github.com/cloud-barista/cb-tumblebug/pull/879)
- Added and tested IBM(VPC) CSP and Tencent CSP [#969](https://github.com/cloud-barista/cb-tumblebug/discussions/969)
- Add option=terminate for delete mci [#959](https://github.com/cloud-barista/cb-tumblebug/pull/959)
- Expedite speed of scripts
- Add SystemLabel field to MCI info for CB-DF CB-MCKS CB-webtool integration [#977](https://github.com/cloud-barista/cb-tumblebug/pull/977)
...
- Add VMGroup parameter in create MCI API
- Add Private IP parameter in get MCI status API
- Add MCI Refine option in MCI action (get) API
- Add verifiedUserName parameter in get spec API
- Add API for ListResourceId, ListMciId, ListVmId 
...
- Enhance and expedite mci lifecycle handling [#625](https://github.com/cloud-barista/cb-tumblebug/pull/625)
- Add MCI Refine feature [#572](https://github.com/cloud-barista/cb-tumblebug/pull/572)
- Add feature for general TB object retrieve [#417](https://github.com/cloud-barista/cb-tumblebug/pull/417)
- Add initial code for mci and vm plan with location-based algo [#511](https://github.com/cloud-barista/cb-tumblebug/pull/511)
...
- Fix initial failed status in MCI provisioning [#467](https://github.com/cloud-barista/cb-tumblebug/pull/467)
...
- MCI 생성 API의 모니터링 에이전트 자동 배치 옵션 제공

### Feature
- MCI 생성시 모니터링 에이전트 자동 배치 기능 추가
- MCI 자동 제어 기능 추가
...
### Feature
- MCI 및 VM에 현재 수행 중인 제어 명령 정보를 관리
- 멀티 클라우드 동적 성능 밴치마킹 기능 일부 추가 (PoC 수준)
- MCI VM 생성 및 제어시 Goroutine을 적용하여 속도 개선
- MCI 및 VM 원격 커맨드 기능 추가
- MCI 오브젝트 정보 보완 (VM의 위경도 정보 제공)
