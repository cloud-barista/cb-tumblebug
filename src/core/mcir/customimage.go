...
type TbCustomImageInfo struct {
	...
	ConnectionName       string            `json:"connectionName"`
	SourceVmId           string            `json:"sourceVmId"`
	CspCustomImageId     string            `json:"cspCustomImageId,omitempty"`
	CspCustomImageName   string            `json:"cspCustomImageName,omitempty"`
	Description          string            `json:"description"`
	CreationDate         time.Time         `json:"creationDate,omitempty"`
	GuestOS              string            `json:"guestOS,omitempty"` // Windows7, Ubuntu etc.
	Status               CustomImageStatus `json:"status"`
