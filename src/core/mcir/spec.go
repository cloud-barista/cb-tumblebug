...
type TbSpecInfo struct { // Tumblebug
	Namespace             string   `json:"namespace" xorm:"namespace"` // required to save in RDB
	Id                    string   `json:"id" xorm:"id"`
	Name                  string   `json:"name" xorm:"name"`
	ConnectionName        string   `json:"connectionName" xorm:"connectionName"`
	CspSpecName           string   `json:"cspSpecName" xorm:"cspSpecName"`
	Os_type               string   `json:"os_type" xorm:"os_type"`
	Num_vCPU              uint16   `json:"num_vCPU" xorm:"num_vCPU"`
	Num_core              uint16   `json:"num_core" xorm:"num_core"`
	Mem_GiB               uint16   `json:"mem_GiB" xorm:"mem_GiB"`
	Storage_GiB           uint32   `json:"storage_GiB" xorm:"storage_GiB"`
	Description           string   `json:"description" xorm:"description"`
	Cost_per_hour         float32  `json:"cost_per_hour" xorm:"cost_per_hour"`
	Num_storage           uint8    `json:"num_storage" xorm:"num_storage"`
	Max_num_storage       uint8    `json:"max_num_storage" xorm:"max_num_storage"`
	Max_total_storage_TiB uint16   `json:"max_total_storage_TiB" xorm:"max_total_storage_TiB"`
	Net_bw_Gbps           uint16   `json:"net_bw_Gbps" xorm:"net_bw_Gbps"`
	Ebs_bw_Mbps           uint32   `json:"ebs_bw_Mbps" xorm:"ebs_bw_Mbps"`
	Gpu_model             string   `json:"gpu_model" xorm:"gpu_model"`
	Num_gpu               uint8    `json:"num_gpu" xorm:"num_gpu"`
	Gpumem_GiB            uint16   `json:"gpumem_GiB" xorm:"gpumem_GiB"`
	Gpu_p2p               string   `json:"gpu_p2p" xorm:"gpu_p2p"`
	OrderInFilteredResult uint16   `json:"orderInFilteredResult" xorm:"orderInFilteredResult"`
	EvaluationStatus      string   `json:"evaluationStatus" xorm:"evaluationStatus"`
	EvaluationScore_01    float32  `json:"evaluationScore_01" xorm:"evaluationScore_01"`
	EvaluationScore_02    float32  `json:"evaluationScore_02" xorm:"evaluationScore_02"`
	EvaluationScore_03    float32  `json:"evaluationScore_03" xorm:"evaluationScore_03"`
	EvaluationScore_04    float32  `json:"evaluationScore_04" xorm:"evaluationScore_04"`
	EvaluationScore_05    float32  `json:"evaluationScore_05" xorm:"evaluationScore_05"`
	EvaluationScore_06    float32  `json:"evaluationScore_06" xorm:"evaluationScore_06"`
	EvaluationScore_07    float32  `json:"evaluationScore_07" xorm:"evaluationScore_07"`
	EvaluationScore_08    float32  `json:"evaluationScore_08" xorm:"evaluationScore_08"`
	EvaluationScore_09    float32  `json:"evaluationScore_09" xorm:"evaluationScore_09"`
	EvaluationScore_10    float32  `json:"evaluationScore_10" xorm:"evaluationScore_10"`
	AssociatedObjectList  []string `json:"associatedObjectList" xorm:"associatedObjectList"`
	IsAutoGenerated       bool     `json:"isAutoGenerated" xorm:"isAutoGenerated"`
}
