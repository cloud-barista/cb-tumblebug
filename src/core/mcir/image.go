...
type TbImageInfo struct {
	...
	CspImageId           string            `json:"cspImageId" xorm:"cspImageId"`
	CspImageName         string            `json:"cspImageName" xorm:"cspImageName"`
	Description          string            `json:"description,omitempty" xorm:"description"`
	CreationDate         string            `json:"creationDate,omitempty" xorm:"creationDate"`
	GuestOS              string            `json:"guestOS,omitempty" xorm:"guestOS"` // Windows7, Ubuntu etc.
	Status               string            `json:"status,omitempty" xorm:"status"`   // available, unavailable
	KeyValueList         []common.KeyValue `json:"keyValueList,omitempty" xorm:"keyValueList"`
