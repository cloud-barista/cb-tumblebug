...
// @Param dataDiskInfo body resource.TbDataDiskReq true "Details for an Data Disk object"
// @Success 200 {object} resource.TbDataDiskInfo
...
// @Accept  json
// @Produce  json
// @Param dataDiskUpsizeReq body resource.TbDataDiskUpsizeReq true "Request body to upsize the dataDisk"
// @Param nsId path string true "Namespace ID" default(default)
...
func RestPutDataDisk(c echo.Context) error {
	...
	u := &resource.TbDataDiskUpsizeReq{}
	if err := c.Bind(u); err != nil {
		return common.EndRequestWithLog(c, reqID, err, nil)
	}
...
// @Accept  json
// @Produce  json
// @Param attachDetachDataDiskReq body resource.TbAttachDetachDataDiskReq false "Request body to attach/detach dataDisk"
// @Param nsId path string true "Namespace ID" default(default)
...
func RestPutVmDataDisk(c echo.Context) error {
	...
	u := &resource.TbAttachDetachDataDiskReq{}
	if err := c.Bind(u); err != nil {
		return common.EndRequestWithLog(c, reqID, err, nil)
	}
...
// @Accept  json
// @Produce  json
// @Param dataDiskInfo body resource.TbDataDiskVmReq true "Details for an Data Disk object"
// @Param nsId path string true "Namespace ID" default(default)
// @Param mciId path string true "MCI ID" default(mci01)
// @Param vmId path string true "VM ID" default(g1-1)
// @Success 200 {object} infra.TbVmInfo
...
func RestGetVmDataDisk(c echo.Context) error {
	...
	if optionFlag == "id" {
		...
		content = RestGetAllDataDiskResponse{
			DataDisk: result.([]resource.TbDataDiskInfo),
		}
	}
