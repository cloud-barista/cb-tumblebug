...
func RunServer() {
	...
	// Namespace-wide NLB listing (read-only; NLBs are created under an Infra)
	g.GET("/:nsId/resources/nlb", rest_infra.RestGetAllNLBInNs)
	// Namespace-wide Node listing (read-only; Nodes are created under an Infra)
	g.GET("/:nsId/resources/node", rest_infra.RestGetAllNodeInNs)
