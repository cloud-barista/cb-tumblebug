...
func RunServer() {
	...
	g.DELETE("/:nsId/deregister/mci/:mciId/vm/:vmId", rest_infra.RestDeregisterMciVm)
	...
	g.DELETE("/:nsId/deregister/dataDisk/:resourceId", rest_resource.RestDeregisterResource)
	...
	g.DELETE("/:nsId/deregister/customImage/:resourceId", rest_resource.RestDeregisterResource)
	...
	g.DELETE("/:nsId/deregister/sshKey/:resourceId", rest_resource.RestDeregisterResource)
	...
	g.DELETE("/:nsId/deregister/securityGroup/:resourceId", rest_resource.RestDeregisterResource)
	...
	g.DELETE("/:nsId/deregister/vNet/:vNetId", rest_resource.RestDeleteDeregisterVNet)
	g.POST("/:nsId/registerCspResource/vNet/:vNetId/subnet", rest_resource.RestPostRegisterSubnet)
	g.DELETE("/:nsId/deregister/vNet/:vNetId/subnet/:subnetId", rest_resource.RestDeleteDeregisterSubnet)
