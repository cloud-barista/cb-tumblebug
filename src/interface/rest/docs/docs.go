        ...
        "/ns/{nsId}/mciDynamicReview": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Request body to review MCI dynamic provisioning. Must include commonSpec and commonImage info of each VM request. Same format as /mciDynamic endpoint. (ex: {name: mci01, vm: [{commonImage: aws+ap-northeast-2+ubuntu22.04, commonSpec: aws+ap-northeast-2+t2.small}]})",
                        "name": "mciReq",
                        "in": "body",
                        "required": true,
                        "schema": {
