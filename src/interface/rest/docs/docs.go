...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.BuildAgnosticImageReq"
                        }
                    },
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.BuildAgnosticImageResult"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "model.CommandStatusListResponse": {
            ...
            "properties": {
                "commands": {
                    "description": "Commands is the list of command status info matching the filter criteria",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.CommandStatusInfo"
                    }
                ...
                "total": {
                    "description": "Total is the total number of commands matching the criteria (before limit/offset)",
                    "type": "integer",
                    "example": 25
                }
            }
        ...
        "model.HandlingCommandCountResponse": {
            ...
            "properties": {
                "handlingCount": {
                    "description": "HandlingCount is the number of commands currently in 'Handling' status",
                    "type": "integer",
                    "example": 3
                },
                "vmId": {
