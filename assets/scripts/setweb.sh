...
sudo sed -i "s/<a href=\"http:\/\/nginx.com\/\">nginx.com<\/a>.<\/p>/<a href=\"https:\/\/tools.keycdn.com\/geo?host=`curl https://api.ipify.org`\">Check the Location of NGINX HOST<\/a>. <a href=\"http:\/\/`curl https://api.ipify.org`:8888">Call to generate CPU load<\/a>.<\/p>/g" /var/www/html/index.nginx-debian.html
