...
- `~/go/src/github.com/cloud-barista/poc-infraservice/mcism_master/conf/config.yaml` 파일을 수정
...
# bash ~/go/src/github.com/cloud-barista/poc-infraservice/1.agent_protoc_build.sh
```
- mcism_master 빌드
```Shell
# cd ~/go/src/github.com/cloud-barista/poc-infraservice/mcism_master
# go build
```
