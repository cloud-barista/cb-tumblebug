...
| **[Global DNS Management](global-dns-management.md)** | Guide for managing DNS records via AWS Route53 — MCI/Label-based IP resolution, simple and geoproximity routing, bulk operations. |
