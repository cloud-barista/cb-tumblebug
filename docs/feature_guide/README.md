...
| **[Resource Reconciliation](resource-reconciliation.md)** | Guide for declarative resource reconciliation, diagnostic state machine, self-healing, and orphaned metadata pruning (`PUT .../reconcile`, `POST .../prune`). |
